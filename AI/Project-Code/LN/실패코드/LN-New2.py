...
def create_tf_dataset(X, Y, batch_size=64, is_train=True):
    # 💡 [핵심 수정] 데이터셋 관리를 CPU로 강제 할당하여 GPU 메모리 터짐 방지
...
if __name__ == "__main__":
    ...
    # 💡 [핵심 수정] RTX 2060 4GB에 맞춰 BATCH_SIZE를 64로 낮춤
    BATCH_SIZE = 64  
