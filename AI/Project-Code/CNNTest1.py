...
# ==========================================
# ⚙️ 1. 설정 (형의 환경에 맞게 수정하세요)
# ==========================================
NTU_SKELETON_DIR = './AI/dataset/nturgb+d_skeletons-npy/'
TCN_H5_PATH = './AI/models/1d-tcn/0408tcn_8layer_pure_ntu.h5'
TCN_TFLITE_PATH = './AI/models/1d-tcn/0408tcn_8layer_pure_ntu.tflite'

TEST_CAMERA = "C001" 
TARGET_FRAMES = 60

# ==========================================
# 🛠️ 2. 옛날 성공 로직 (보간 + max_dist)
# ==========================================
def preprocess_old_success_logic(skeleton_data):
    """
    영상 전체를 60프레임으로 보간하고 max_dist로 정규화하는 성공 로직
    """
    # 차원 정리 (N, 1, 39) -> (N, 13, 3)
...
def print_metrics(tag, y_true, y_pred):
    ...
    print(f"\n📊 [{tag}] Accuracy: {acc*100:.2f}% | Recall: {rec*100:.2f}%")
