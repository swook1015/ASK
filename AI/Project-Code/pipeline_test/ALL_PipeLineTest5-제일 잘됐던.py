...
LN_MODEL_PATH   = './AI/models/ln/new_lpn_cv_60_legacy.tflite' #new_lpn_cv_60_legacy.tflite
TCN_MODEL_PATH  = './AI/models/1d-tcn/tcn_manual_fixed.tflite' #tcn_manual_fixed.tflite
...
def center_poses_2d_final(X_2d_window):
    # 골반 중심 기준 영점 조절 및 Y축 반전 [cite: 121, 144]
...
for v_path in video_files:
    ...
    # 영상 저장용 Writer 설정 (늘어난 프레임만큼 저장됨)
