...
# 1. 경로 설정
model_path = './AI/models/lpn/lpn_remaster_60_legacy.h5'
input_2d_path = './AI/dataset/LPN-train/ntu_lpn_input_2d_final.npy'
target_3d_path = './AI/dataset/LPN-label/ntu_lpn_target_3d_shuffled.npy'
