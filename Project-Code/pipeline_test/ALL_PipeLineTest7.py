...
for v_path in video_files:
    ...
    prev_kpts = None
    smoothed_kpts = None  
    ALPHA = 0.85  # 반응성과 안정성의 타협점

    # [STEP 1] 관절 추출 및 EMA 필터
    while cap.isOpened():
        ret, frame = cap.read()
        if not ret: break
    ...
    # [STEP 2] ✅ 패딩 로직 복구 (초반 낙상 신호 희석 방지 및 Cold Start 해결)
